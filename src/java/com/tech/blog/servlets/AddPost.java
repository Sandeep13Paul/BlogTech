...
import com.tech.blog.dao.Post_Dao;
...
public class AddPost extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String pCode = request.getParameter("post_program");
...
//            out.println(cid + " " + pCode + " " + pContent + " " + pPic + " " + pTitle + " " + uid);
            
//            getting post
            Post p = new Post(uid, pTitle, pContent, pCode, pPic, null, cid, uid);
